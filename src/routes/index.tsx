...
import { ArrowRight, ArrowUpRight, Award, Factory, Globe2, ShieldCheck, Sparkles, Layers, Zap } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium stainless steel sheets, coils, pipes, flanges & fittings. Authorized distributor of JSL & SAIL. Trusted globally." },
    ],
  }),
  component: Home,
});
...
const CATEGORIES = [
  { name: "Stainless Steel Sheets", img: sheets, desc: "Cold rolled, hot rolled & finished sheets in 200 / 300 / 400 series." },
  { name: "Coils", img: coils, desc: "Precision slit coils for fabrication, automotive & engineering." },
  { name: "Pipes & Tubes", img: pipes, desc: "Seamless and welded pipes meeting ASTM / ASME standards." },
];

const INDUSTRIES = ["Oil & Gas", "Petrochemicals", "Power Plants", "Pharmaceuticals", "Marine", "Infrastructure", "Heavy Engineering", "Automotive"];
        ...
        <Container className="relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold leading-[0.95] tracking-tight">
              <span className="text-gradient-steel">Forging</span><br />
              <span className="text-foreground">a legacy in</span><br />
              <span className="text-gradient-glow">stainless steel.</span>
            </h1>
            <p className="mt-8 text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed">
              Four decades of precision, partnership and uncompromising quality — supplying world-class stainless steel and alloy solutions to industry leaders worldwide.
            </p>
            <div className="mt-10 flex flex-wrap gap-3">
              <Link to="/products" className="group inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-gradient-to-r from-[oklch(0.62_0.14_235)] to-[oklch(0.5_0.18_250)] text-white text-sm font-medium shadow-glow hover:shadow-[0_0_80px_oklch(0.62_0.14_235/0.6)] transition-all">
                Explore Products <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link to="/contact" className="group inline-flex items-center gap-2 px-6 py-3.5 rounded-full glass text-sm font-medium hover:border-primary/40 transition-all">
                Send Inquiry <ArrowUpRight className="h-4 w-4 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
              </Link>
            </div>
          </motion.div>
        </Container>
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }} className="absolute bottom-10 left-1/2 -translate-x-1/2 text-[10px] uppercase tracking-[0.3em] text-muted-foreground">
          Scroll to discover
        </motion.div>
      </section>
            ...
            {[
              ...
              <FadeIn key={s.l} delay={i * 0.08}>
                <div className="bg-card p-8 md:p-10 h-full">
                  <div className="text-4xl md:text-5xl font-display font-semibold text-gradient-steel">{s.v}</div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <FadeIn>
              ...
              <h2 className="text-4xl md:text-5xl font-semibold leading-tight">
                Born in <span className="text-gradient-steel">CP Tank, Mumbai</span> — one of India's stainless steel hubs.
              </h2>
              <p className="mt-6 text-muted-foreground leading-relaxed">
                Founded in 1983 by Mr. Rajnesh Bhandari, Bhandari Metals & Alloys has spent over four decades pioneering reliable stainless steel solutions. As the next generation continues the legacy, we combine deep industry expertise with a modern, global business vision.
              </p>
        ...
        <Container>
          <div className="flex items-end justify-between mb-12 gap-8 flex-wrap">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-semibold max-w-xl">Engineered for the world's most demanding industries.</h2>
            </div>
            <Link to="/products" className="text-sm text-primary inline-flex items-center gap-2 hover:gap-3 transition-all">View all products <ArrowRight className="h-4 w-4" /></Link>
          </div>
                ...
                <Link to="/products" className="group relative block aspect-[4/5] rounded-2xl overflow-hidden glass">
                  ...
                  <div className="absolute inset-0 p-7 flex flex-col justify-end">
                    ...
                    <div className="mt-4 inline-flex items-center gap-2 text-xs text-primary">
                      Explore <ArrowUpRight className="h-3.5 w-3.5 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
                    </div>
                  </div>
                </Link>
              </FadeIn>
      ...
      <Section>
        <Container>
          <FadeIn className="max-w-2xl mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-semibold">Precision. Partnership. <span className="text-gradient-steel">Pedigree.</span></h2>
          </FadeIn>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { icon: Award, t: "40+ Year Legacy", d: "Four decades of trusted supply across India and beyond." },
              { icon: ShieldCheck, t: "Certified Quality", d: "Every grade meets ASTM, ASME and global standards." },
              { icon: Factory, t: "JSL & SAIL Distributor", d: "Direct sourcing from India's premier steel makers." },
              { icon: Globe2, t: "Global Supply", d: "Engineered logistics for international industrial demand." },
            ].map((f, i) => (
            ...
            <div className="relative overflow-hidden rounded-3xl glass p-10 md:p-16">
              ...
              <div className="relative grid md:grid-cols-2 gap-10 items-center">
                <div>
                  ...
                  <h3 className="text-3xl md:text-4xl font-semibold leading-tight">Direct partnership with India's steel giants — <span className="text-gradient-steel">JSL</span> & <span className="text-gradient-steel">SAIL</span>.</h3>
                </div>
      ...
      <Section>
        <Container>
          <FadeIn className="max-w-2xl mb-14">
            ...
            <h2 className="text-4xl md:text-5xl font-semibold">Powering the backbone of <span className="text-gradient-steel">modern industry.</span></h2>
          </FadeIn>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {INDUSTRIES.map((i, idx) => (
              <FadeIn key={i} delay={idx * 0.04}>
                <Link to="/industries" className="group block p-5 rounded-xl glass hover:border-primary/40 transition-all">
            ...
            <FadeIn>
              <Link to="/infrastructure" className="group relative block aspect-[4/3] rounded-2xl overflow-hidden glass">
                ...
                <div className="absolute inset-0 p-8 md:p-10 flex flex-col justify-end">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground max-w-md">Modern warehousing, processing & logistics engineered for precision delivery.</p>
                </div>
              </Link>
            </FadeIn>
            <FadeIn delay={0.1}>
              <Link to="/technical" className="group relative block aspect-[4/3] rounded-2xl overflow-hidden glass">
                <div className="absolute inset-0 bg-gradient-to-br from-[oklch(0.22_0.04_235)] to-[oklch(0.14_0.005_240)]" />
                <div className="absolute inset-0 grid-bg opacity-30" />
                <div className="absolute inset-0 p-8 md:p-10 flex flex-col justify-end">
                  <Zap className="h-8 w-8 text-primary mb-4" />
                  <h3 className="text-3xl font-display font-semibold">Technical excellence, documented.</h3>
                  <p className="mt-2 text-sm text-muted-foreground max-w-md">Material grades, mechanical properties & ASTM/ASME specifications at your fingertips.</p>
                </div>
              </Link>
            </FadeIn>
          </div>
            ...
            <div className="relative overflow-hidden rounded-3xl p-12 md:p-20 text-center glass">
              ...
              <div className="relative">
                ...
                <h2 className="text-4xl md:text-6xl font-semibold leading-tight max-w-3xl mx-auto">
                  Let's build your next <span className="text-gradient-steel">project together.</span>
                </h2>
                <p className="mt-6 text-muted-foreground max-w-xl mx-auto">From concept to consignment — partner with a name India has trusted for over four decades.</p>
                <Link to="/contact" className="mt-10 inline-flex items-center gap-2 px-7 py-4 rounded-full bg-gradient-to-r from-[oklch(0.62_0.14_235)] to-[oklch(0.5_0.18_250)] text-white text-sm font-medium shadow-glow">
