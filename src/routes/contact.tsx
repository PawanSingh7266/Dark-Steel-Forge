...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Bhandari Metals & Alloys" },
      {
        name: "description",
        content: "Get in touch for inquiries, quotes and partnership discussions.",
      },
    ],
  }),
  component: Contact,
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Let's <span className="text-gradient-glow">talk steel.</span>
          </>
        }
                ...
                {[
                  {
                    ...
                    href: "https://www.google.com/maps/search/?api=1&query=Bhandari+Metals+%26+Alloys+452C%2BG66+Manikkam+Pillai+St+Periyar+Nagar+Mannurpet+Chennai+Tamil+Nadu+600058",
                  },
                  ...
                  <div key={c.t} className="p-5 rounded-xl glass flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {c.href ? (
                        <a href={c.href} className="text-sm hover:text-primary transition-colors">
                          {c.d}
                        </a>
                      ) : (
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    required
                    rows={5}
                    className="mt-2 w-full bg-input/40 border border-border rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/40 transition-all resize-none"
                    placeholder="Tell us about grades, dimensions and quantities required..."
                  />
                </div>
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-gradient-to-r from-[oklch(0.62_0.14_235)] to-[oklch(0.5_0.18_250)] text-white text-sm font-medium shadow-glow hover:shadow-[0_0_60px_oklch(0.62_0.14_235/0.5)] transition-all"
                >
        ...
        <Container>
          <FadeIn>
            <div className="rounded-2xl overflow-hidden glass aspect-[16/7]">
              <iframe
                title="Map"
                src="https://www.google.com/maps?q=Bhandari+Metals+%26+Alloys%2C+452C%2BG66%2C+Manikkam+Pillai+St%2C+Periyar+Nagar%2C+Mannurpet%2C+Chennai%2C+Tamil+Nadu+600058&output=embed"
                width="100%"
                height="100%"
                style={{
                  border: 0,
  ...
  return (
    <div>
      ...
      <input
        ...
        type={type}
        required
        className="mt-2 w-full bg-input/40 border border-border rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/40 transition-all"
      />
    </div>
  );
}
